...
import File from './helpers/read-write-file.js';
...
const server = createServer((req, res) => {
    ...
    switch (req.url) {
        ...
        default:
            const errorMessage = req.url === '/error' ? req.url : ` ${req.url} does not exist`
            File.readFile('./src/html/error.html', res, errorMessage);
            break;
    }
})
